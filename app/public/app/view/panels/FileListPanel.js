...
Ext.define("FM.view.panels.FileListPanel", {
  ...
  initEmptyContextMenu: function () {
    ...
    items = [];
    if (
      FM.helpers.isAllowed(FM.Actions.NewFile, this, []) &&
      this.session.type !== "webdav"
    ) {
      items.push({
  ...
  getContextMenu: function (record) {
    ...
    if (
      FM.helpers.isAllowed(FM.Actions.ExtractArchive, this, selection_array)
    ) {
      items.push({
        ...
        handler: (function (_this) {
          return function () {
            ...
            return FM.Actions.Copy.execute(
              _this,
              FM.helpers.NextPanel(_this),
              FM.helpers.NextPanel(_this).session.path,
              records
            );
          };
        })(this),
      ...
      items.push({
        ...
        handler: (function (_this) {
          return function () {
            var records;
            records = FM.helpers.GetSelected(_this);
            return FM.Actions.Move.execute(
              _this,
              FM.helpers.NextPanel(_this),
              records
            );
  ...
  updateStatusBar: function () {
    ...
    return status_bar.setText(
      t(
        "Size: $1, dirs: $2, files: $3",
        FM.helpers.SizeFormat(size),
        dirs,
        files
      )
    );
  ...
  updatePathBar: function () {
    ...
    for (key = i = 0, len = crumbs.length; i < len; key = ++i) {
      ...
      dirs.push(
        '<span onclick="FM.Actions.Open.execute(FM.' +
          this +
          ", '" +
          crumb_path +
          "');\">" +
