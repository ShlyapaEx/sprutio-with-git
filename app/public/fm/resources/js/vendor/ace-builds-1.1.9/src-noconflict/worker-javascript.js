          ...
          function (_dereq_, module, exports) {
            ...
            var JSHINT = (function () {
                        ...
                        if (left) {
                          ...
                          if (left.id === ".") {
                            ...
                            if (state.tokens.curr.left.first) {
                              state.tokens.curr.left.first.forEach(function (
                                t
                              ) {
              ...
              function isMethod() {
                return (
                  (funct["(statement)"] &&
                    funct["(statement)"].type === "class") ||
                  (funct["(context)"] &&
                    funct["(context)"]["(verb)"] === "class")
                );
              }
                ...
                for (;;) {
                  ...
                  if (state.tokens.next.id === "=") {
                    ...
                    if (peek(0).id === "=" && state.tokens.next.identifier) {
                      if (
                        !funct["(params)"] ||
                        funct["(params)"].indexOf(state.tokens.next.value) ===
                          -1
                      ) {
                        warning(
                          "W120",
                ...
                try {
                  ...
                  functions.forEach(function (func) {
                    ...
                    while (param) {
                      type = func[param];
                      unused_opt =
                        func["(unusedOption)"] || state.option.unused;
                      unused_opt =
