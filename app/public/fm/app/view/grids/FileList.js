...
Ext.define("FM.view.grids.FileList", {
  ...
  initStore: function (listing) {
    ...
    if (
      ...
      session != null &&
      session.type != null &&
      session.type === FM.Session.WEBDAV
    ) {
  ...
  initDropZone: function () {
    ...
    return (this.drop_zone = Ext.create("Ext.dd.DropZone", view.getEl(), {
      ...
      onNodeOver: function (nodeData, source, e, data) {
        ...
        if (
          !FM.helpers.isAllowed(FM.Actions.Copy, source_panel, source_records)
        ) {
      ...
      onNodeDrop: function (nodeData, source, e, data) {
        ...
        if (target_record != null) {
          if (target_record.get("is_dir")) {
            FM.Logger.debug(
              "target_path = ",
              FM.helpers.GetAbsName(target_panel.session, target_record)
            );
            return FM.Actions.Copy.execute(
              source_panel,
              target_panel,
              FM.helpers.GetAbsName(target_panel.session, target_record),
              source_records
    ...
    this.handlers = {
      gridview: {
        ...
        beforeitemmousedown: function (view) {
          ...
          menus = Ext.ComponentQuery.query(
            "menu[name=fm-file-list-context-menu]"
          );
          results = [];
      ...
      columns: [
        {
          ...
          renderer: function (value, metaData, record) {
            ...
            metaData.style =
              "background-image: url(/fm/resources/images/sprites/icons_16.png)";
            metaData.tdCls =
              ext !== ""
                ? "cell-icon icon-16-" + ext
                : "cell-icon icon-16-_blank";
            if (is_dir) {
              return value;
            } else {
  ...
  hasListCache: function (path) {
    FM.Logger.log(
      ...
      path,
      this.list_cache,
      this.list_cache[path] != null
    );
    if (
      this.list_cache[path] != null &&
      this.list_cache[path].items != null &&
      this.list_cache[path].items.length > 0
    ) {
          ...
          fn: FM.HotKeys.HotKeyDecorator(function (key, e) {
            ...
            if (records.length === 0) {
              ...
              if (FM.helpers.isAllowed(FM.Actions.Remove, FM.Active, records)) {
                FM.Actions.Remove.execute(
                  FM.Active,
                  FM.helpers.GetAbsNames(FM.Active.session, records)
                );
              }
              return e.stopEvent();
            }
        ...
        },
        {
          ...
          fn: FM.HotKeys.HotKeyDecorator(function (key, e) {
            ...
            if (FM.helpers.isAllowed(FM.Actions.Copy, FM.Active, records)) {
              FM.Actions.Copy.execute(
                FM.Active,
                FM.Inactive,
                FM.Inactive.session.path,
                records
              );
            }
            return e.stopEvent();
          ...
          fn: FM.HotKeys.HotKeyDecorator(function (key, e) {
            ...
            if (records.length === 0) {
              ...
              if (FM.helpers.isAllowed(FM.Actions.Remove, panel, records)) {
                FM.Actions.Remove.execute(
                  panel,
                  FM.helpers.GetAbsNames(panel.session, records)
                );
              }
              return e.stopEvent();
            }
