            ...
            // },
            {
              ...
              handler: function () {
                ...
                if (records.length === 0) {
                  ...
                  return FM.Actions.Remove.execute(
                    panel,
    ...
    this.items.push({
      ...
      menu: [
            ...
            return function () {
              ...
              if (record) {
                if (record.get("is_dir")) {
                  return FM.Actions.Open.execute(
                    FM.Active,
                    FM.helpers.GetAbsName(FM.Active.session, record)
                  );
                }
              } else {
                return FM.helpers.ShowError(t("Please select file entry."));
        ...
        },
        {
          ...
          handler: (function (_this) {
            return function () {
              return FM.Actions.AnalyzeSize.execute(
                FM.Active,
                FM.Active.session.path
              );
            };
          })(this),
        },
