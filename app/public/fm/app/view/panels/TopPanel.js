...
Ext.define("FM.view.panels.TopPanel", {
  ...
  updateButtonsState: function (panel, files) {
    var analyze_size_button,
      ...
      search_text_button,
      upload_button;
    home_button = Ext.ComponentQuery.query(
      "button[name=" + FM.Actions.HomeFtp.getIconCls() + "]",
      this.items.get(0)
    )[0];
    remote_button = Ext.ComponentQuery.query(
      "button[name=" + FM.Actions.RemoteConnections.getIconCls() + "]",
      this.items.get(0)
    )[0];
    refresh_button = Ext.ComponentQuery.query(
      "button[name=" + FM.Actions.Refresh.getIconCls() + "]",
      this.items.get(0)
    )[0];
    mkdir_button = Ext.ComponentQuery.query(
      "button[name=" + FM.Actions.NewFolder.getIconCls() + "]",
      this.items.get(0)
    )[0];
    upload_button = Ext.ComponentQuery.query(
      "button[name=" + FM.Actions.Upload.getIconCls() + "]",
      this.items.get(0)
    )[0];
    create_archive_button = Ext.ComponentQuery.query(
      "button[name=" + FM.Actions.CreateArchive.getIconCls() + "]",
      this.items.get(0)
    )[0];
    download_archive_button = Ext.ComponentQuery.query(
      "button[name=" + FM.Actions.DownloadArchive.getIconCls() + "]",
      this.items.get(0)
    )[0];
    search_files_button = Ext.ComponentQuery.query(
      "button[name=" + FM.Actions.SearchFiles.getIconCls() + "]",
      this.items.get(0)
    )[0];
    search_text_button = Ext.ComponentQuery.query(
      "button[name=" + FM.Actions.SearchText.getIconCls() + "]",
      this.items.get(0)
    )[0];
    analyze_size_button = Ext.ComponentQuery.query(
      "button[name=" + FM.Actions.AnalyzeSize.getIconCls() + "]",
      this.items.get(0)
    )[0];
    ...
    if (FM.helpers.isAllowed(FM.Actions.AnalyzeSize, panel, files)) {
      ...
      panel.session.type === FM.Session.HOME ||
      panel.session.type === FM.Session.SFTP
    ) {
      return analyze_size_button.setDisabled(false);
    } else {
  ...
  updateMenuState: function (panel, files) {
    var analyze_size_button,
      ...
      create_archive_button,
      create_copy_button,
      download_basic_button,
      download_button,
      download_bzip_button,
      download_gzip_button,
      download_tar_button,
      download_zip_button,
      edit_button,
      home_button,
    ...
    home_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.HomeFtp.getIconCls() + "]",
      toolbar
    )[0];
    remote_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.RemoteConnections.getIconCls() + "]",
      toolbar
    )[0];
    refresh_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.Refresh.getIconCls() + "]",
      toolbar
    )[0];
    mkdir_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.NewFolder.getIconCls() + "]",
      toolbar
    )[0];
    new_file_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.NewFile.getIconCls() + "]",
      toolbar
    )[0];
    new_button = Ext.ComponentQuery.query(
      "menuitem[name=fm-action-create]",
      toolbar
    )[0];
    upload_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.Upload.getIconCls() + "]",
      toolbar
    )[0];
    download_button = Ext.ComponentQuery.query("#fm-menu-download", toolbar)[0];
    download_basic_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.DownloadBasic.getIconCls() + "]",
      toolbar
    )[0];
    download_zip_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.DownloadZip.getIconCls() + "]",
      toolbar
    )[0];
    download_gzip_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.DownloadGZip.getIconCls() + "]",
      toolbar
    )[0];
    download_bzip_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.DownloadBZ2.getIconCls() + "]",
      toolbar
    )[0];
    download_tar_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.DownloadTar.getIconCls() + "]",
      toolbar
    )[0];
    search_menu = Ext.ComponentQuery.query("#fm-menu-search", toolbar)[0];
    search_files_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.SearchFiles.getIconCls() + "]",
      toolbar
    )[0];
    search_text_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.SearchText.getIconCls() + "]",
      toolbar
    )[0];
    analyze_size_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.AnalyzeSize.getIconCls() + "]",
      toolbar
    )[0];
    operations_button = Ext.ComponentQuery.query(
      "#fm-menu-operations",
      toolbar
    )[0];
    view_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.View.getIconCls() + "]",
      toolbar
    )[0];
    edit_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.Edit.getIconCls() + "]",
      toolbar
    )[0];
    rename_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.Rename.getIconCls() + "]",
      toolbar
    )[0];
    copy_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.Copy.getIconCls() + "]",
      toolbar
    )[0];
    move_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.Move.getIconCls() + "]",
      toolbar
    )[0];
    create_copy_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.CreateCopy.getIconCls() + "]",
      toolbar
    )[0];
    create_archive_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.CreateArchive.getIconCls() + "]",
      toolbar
    )[0];
    // chmod_button = Ext.ComponentQuery.query("menuitem[name=" + FM.Actions.Chmod.getIconCls() + "]", toolbar)[0];
    remove_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.Remove.getIconCls() + "]",
      toolbar
    )[0];
    ipblock_button = Ext.ComponentQuery.query(
      "menuitem[name=" + FM.Actions.IPBlock.getIconCls() + "]",
      toolbar
    )[0];
    if (FM.helpers.isAllowed(FM.Actions.HomeFtp, panel, files)) {
      home_button.setDisabled(false);
    ...
    if (
      download_zip_button.isDisabled() &&
      download_basic_button.isDisabled() &&
      download_gzip_button.isDisabled() &&
      download_bzip_button.isDisabled() &&
      download_tar_button.isDisabled()
    ) {
    ...
    if (
      view_button.isDisabled() &&
      edit_button.isDisabled() &&
      rename_button.isDisabled() &&
      copy_button.isDisabled() &&
      move_button.isDisabled() &&
      create_copy_button.isDisabled() &&
      create_archive_button.isDisabled() &&
      // chmod_button.isDisabled() &&
      remove_button.isDisabled()
    ) {
